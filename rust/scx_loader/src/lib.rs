...
impl FromStr for SupportedSched {
    ...
    fn from_str(scx_name: &str) -> anyhow::Result<SupportedSched> {
        match scx_name {
            ...
            "scx_flashyspark" => Ok(SupportedSched::Flashyspark),
            "scx_spark" => Ok(SupportedSched::Spark),
...
impl From<SupportedSched> for &str {
    fn from(scx_name: SupportedSched) -> Self {
        match scx_name {
            ...
            SupportedSched::Flashyspark => "scx_flashyspark",
            SupportedSched::Spark => "scx_spark",
        }
    }
}
