...
pub fn get_default_config() -> Config {
    let supported_scheds = [
        ...
        SupportedSched::Flashyspark,
        SupportedSched::Spark,
    ];
...
fn get_default_scx_flags_for_mode(scx_sched: &SupportedSched, sched_mode: SchedMode) -> Vec<&str> {
    match scx_sched {
        ...
        // scx_flashyspark and scx_spark use similar defaults to scx_rusty for now
        SupportedSched::Flashyspark => vec![],
